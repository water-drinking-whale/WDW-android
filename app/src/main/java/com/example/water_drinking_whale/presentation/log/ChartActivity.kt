...
import com.example.water_drinking_whale.databinding.ActivityChartBinding
...
//        var barChart: BarChart = findViewById(R.id.barChart) // barChart 생성
        ...
        barChart.run {
            ...
            axisLeft.run { //왼쪽 축. 즉 Y방향 축을 뜻한다.
                ...
                axisLineColor = ContextCompat.getColor(context,R.color.colorMain) // 축 색깔 설정
                gridColor = ContextCompat.getColor(context,R.color.colorMain) // 축 아닌 격자 색깔 설정
        ...
        set.color = ContextCompat.getColor(applicationContext!!,R.color.black) // 바 그래프 색 설정
